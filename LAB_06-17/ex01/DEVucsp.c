...
// ##################### For Lock sistem #####################
static DEFINE_MUTEX(ucsp_mutex);  /// A macro that is used to declare a new mutex that is visible in this file
...
void cleanup_module(void)
{
    // Aquiiiiiiiiiii debe ir el mutex detroy (&ebbchat_mutex) !!!!!!!!
